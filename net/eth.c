...
extern int ksz8692_initialize(bd_t*);
#endif
#ifdef CONFIG_DRIVER_KS8695ETH
extern int ksz8695_initialize(bd_t*);
#endif
...
#endif
#ifdef CONFIG_DRIVER_KS8692ETH
	ksz8692_initialize(bis);
#endif
#ifdef CONFIG_DRIVER_KS8695ETH
	ksz8695_initialize(bis);
#endif
...
#endif
#if defined(CONFIG_ARCH_KS8692P) && (CONFIG_COMMANDS & CFG_CMD_MII)
	ks8692_miiphy_initialize(bis);
#endif
