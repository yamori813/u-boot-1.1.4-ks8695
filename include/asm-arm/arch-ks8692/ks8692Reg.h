...
#define   EXT_IO0_DW32               0x00003000    /* External I/O bank 0 32-bit data width */
#define   EXT_IO0_DW16               0x00002000    /* External I/O bank 0 16-bit data width */
#define   EXT_IO0_DW8                0x00001000    /* External I/O bank 0 8-bit data width */
...
#define   USB_DEV_ENUM_DONE          0x00020000    /* Enum Done Software driven not present in hardware */
...
#define   USB_DEV_SC                 0x00000001    /* Rcvd Set Configuration Command */
#define   USB_DEV_SI                 0x00000002    /* Rcvd Set Interface Command */
#define   USB_DEV_ES                 0x00000004    /* IDLE > 3ms Detected */
...
#define   USB_DEV_INTR_MASK          ( USB_DEV_SC | USB_DEV_SI | USB_DEV_ES | USB_DEV_UR | USB_DEV_US| /*USB_DEV_SOF |*/ USB_DEV_ENUM )
...
#define   MAX_PKT_SIZE_UDC_REG       0x02000000    /* Max Pkt size field to be programmed into the UDC registers */
...
#define   NAND_CMD_RESET_            0x000000FF    /* Reset command */
...
#define   NAND_SIZE_1GBIT            0x00000005    /* NAND flash size is 1Gbit */
