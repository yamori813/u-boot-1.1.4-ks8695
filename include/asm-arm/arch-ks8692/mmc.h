...
/* Definition of R1 response format */
#define  OUT_OF_RANGE        0x80000000
#define  ADDRESS_ERROR       0x40000000
#define  BLOCK_LEN_ERROR     0x20000000
#define  ERASE_SEQ_ERROR     0x10000000
#define  ERASE_PARAM         0x08000000
#define  WP_VIOLATION        0x04000000
#define  CARD_IS_LOCK        0x02000000
#define  LOCK_UNLOCK_FAILED  0x01000000
#define  COM_CRC_ERROR       0x00800000
#define  ILLEGAL_COMMAND     0x00400000
#define  CARD_ECC_FAILED     0x00200000
#define  CC_ERROR            0x00100000
#define  UNKNOW_ERROR        0x00080000
#define  CSD_OVERWRITE       0x00010000
#define  WP_ERASE_SKIP       0x00008000
#define  CARD_ECC_DISABLED   0x00004000
#define  ERASE_RESET         0x00002000
#define  CURRENT_STATE_MASK  0x00001E00
#define  READY_FOR_DATA      0x00000100
#define  APP_CMD             0x00000020
#define  AKE_SEQ_ERROR       0x00000008

#define  R1_ANYERROR_MASK    0xFDF90008
