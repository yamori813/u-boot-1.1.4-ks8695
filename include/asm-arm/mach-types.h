...
#  define machine_arch_type	__machine_arch_type
# else
#  define machine_arch_type	MACH_TYPE_KS8692P
# endif
# define machine_is_ks8692p()	(machine_arch_type == MACH_TYPE_KS8692P)
#else
# define machine_is_ks8692p()	(0)
#endif
