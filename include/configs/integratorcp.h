...
# define PHYS_FLASH_SIZE 	0x01000000	/* 16MB  May be:: 0x02000000 32MB, 0x04000000 64 MB */
#endif
#define CFG_FLASH_ERASE_TOUT	(2*CFG_HZ)	/* Timeout for Flash Erase */
#define CFG_FLASH_WRITE_TOUT	(2*CFG_HZ)	/* Timeout for Flash Write */

// #define CFG_MONITOR_LEN	U-Boot code size is variable	    
// #define CFG_MONITOR_BASE	U-Boot code is relocatable in flash
 ...
 * register and dynamically assign CFG_ENV_ADDR
 */
...
#define CFG_ENV_ADDR		(ARM_BM_START - CFG_ENV_SECT_SIZE) 	/* One sector for environment*/
