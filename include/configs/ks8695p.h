...
#define CONFIG_ARCH_KS8695P	1

#define CONFIG_USE_IRQ			/* we need to use IRQ/FIQ stuff	*/
...
#if 1
/* Include Micrel Ethernet diagnostics code. */
#define CONFIG_KSETHER
#endif

#if 1
#define	CONFIG_COMMANDS		(CONFIG_CMD_DFL | CFG_CMD_PING |CFG_CMD_DHCP | CFG_CMD_PCI)
...
#define	CONFIG_ETH1ADDR		00:10:A1:86:95:11
