...
#endif
#define CONFIG_KS8692_NAND  1		/* it is KS8692P based NAND Boot */
#define CONFIG_NAND_SMALLBLOCK		/* undef this if LARGEBLOCK is used */
...
#define	CONFIG_COMMANDS		(CONFIG_CMD_DFL & ~(CFG_CMD_NONSTD | CFG_CMD_IMLS | CFG_CMD_FLASH) | \
                             CFG_CMD_PCI |                        \
                             CFG_CMD_PING |                       \
                             CFG_CMD_DHCP |                       \
                             CFG_CMD_MII |                        \
                             ...
                             ADD_USB_CMD)
#else
#define	CONFIG_COMMANDS		(CONFIG_CMD_DFL & ~(CFG_CMD_NONSTD) | CFG_CMD_PCI | CFG_CMD_PING | CFG_CMD_DHCP | CFG_CMD_NAND | ADD_USB_CMD)
#endif
...
/* uboot(0x20000) + env */
#define CONFIG_BOOTCOMMAND	"nboot 2000000 0 40000; bootm"
...
#define	U_BOOT_CODE_SIZE	(PHYS_FLASH_SECT_SIZE * 3)
...
#ifdef CONFIG_NAND_SMALLBLOCK
#define CFG_ENV_OFFSET		0x38000
#define CFG_ENV_OFFSET_REDUND	0x3C000
...
#define CFG_PHY0_ADDR		0x1F
#define CFG_PHY1_ADDR		0x1E
#else
